      ...
      <div className="reni-section">
        ...
        <div className="reneCarloniContent text-white">
          ...
          <p className="mt-5">
            ...
            Centers and Mortgage Centre Franchises. Rene has over two decades of
            lending experience, including 15 as a licensed mortgage broker and
            has been involved in nearly every type of financing you can think
            of.
          </p>
          <p className="mt-5">
            ...
            companies. He has real life and professional experience with complex
            transactions. Rene understands clients who are going through
            divorce, difficult family situations, business ups and downs and
            renovations. Rene can sit with a client and really understand their
            needs and offer the best possible financial advice and positioning
            while incorporating the lowest possible rate. This allows his
            clients to move forward in whichever life and housing decision fits
