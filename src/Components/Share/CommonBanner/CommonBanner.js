    ...
    <div>
      ...
      {pathname.includes("/testimonials") && (
        <div className="testimonialBannerComponent">
          <h1 className="text-white text-6xl my-8 font-semibold">
            <span className="highliteText"> Happy </span> Customers <br /> Say{" "}
            <span className="highliteText"> ABOUT </span> Us
          </h1>
        </div>
      )}
      {pathname.includes("/contact") && (
        <div className="contactBannerComponent">
          <h1 className="text-white text-6xl my-8 font-semibold">
            ...
            Call Should <span className="highliteText"> SAVE </span> YOU <br />{" "}
            Thousands!
          </h1>
        </div>
      )}
      {pathname.includes("/serviceDetails") && (
        <div className="commonBannerComponent">
          <h1 className="text-white text-6xl my-8 font-semibold">
            Mortgage for Buying a <br />
            <span className="highliteText">House</span> or Condo
          </h1>
        </div>
      )}
    </div>
