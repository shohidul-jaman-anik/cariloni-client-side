      ...
      <footer className="footerContainer footer p-10 bg-neutral text-neutral-content">
        <div>
          ...
          <div className="grid grid-cols-4 gap-x-3">
            ...
            <Link to="#facebook" className="facebookBtn m-2 w-10 h-10 inline-flex justify-center items-center shadow-sm rounded-full border-2 " style={{ borderColor: "#ffffff", color: "#ffffff" }}>
              {/* ::facebook svg */}
            ...
            {/* :Twitter */}
            <Link to="#twitter" className="twitterBtn m-2 w-10 h-10 inline-flex justify-center items-center shadow-sm rounded-full border-2" style={{ borderColor: "#ffffff", color: "#ffffff" }}>
              {/* ::twitter svg */}
            ...
            {/* :Linkedin */}
            <Link to="#linkedin" className="linkedInBtn m-2 w-10 h-10 inline-flex justify-center items-center shadow-sm rounded-full border-2" style={{ borderColor: "#ffffff", color: "#ffffff" }}>
              {/* ::linkedin svg */}
              <svg className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            {/* :Instagram */}
            <Link to="#instagrap" className="InstaBtn border-2 relative m-2 p-0.5 w-10 h-10 inline-flex justify-center items-center shadow-sm rounded-full bg-transparent text-white">
              {/* ::instagram svg */}
